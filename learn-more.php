...
<head>
	...
	<title>Birdsong for the Curious Naturalist: Learn More</title>
	...
	<section id="content">
		<div class="sidebar">
			<ul id="menu" class="side">
				...
				<li class="active"><a href="#about-the-book"><i class="fas fa-book"></i> About the Book</a></li>
	  			<li><a href="#about-the-author"><i class="fas fa-user"></i> About the Author</a></li>
				<li><a href="#enjoy-the-sounds"><i class="fas fa-headphones-alt"></i> Enjoy the Sounds</a></li>
	  			<li><a href="#credits"><i class="fas fa-award"></i> Credits</a></li>
	  			<li><a href="#recording-birdsong"><i class="fas fa-microphone"></i> Recording Birdsong</a></li>
	  			<li><a href="#additional-resources"><i class="fas fa-info"></i> Additional Resources</a></li>
		...
		<div class="main switcher">
			...
			<div id="recording-birdsong" class="switch">
				<h2>Recording Birdsong</h2>
				
				<p class="lead">Soon you won't be content using the recordings that others supply for you, and you will want to make your own. With modern technology, that undertaking is increasingly simple, and increasingly inexpensive.</p> 
				<p>Rather than provide my own guidelines for recording, I refer you to the Macaulay Library: https://www.macaulaylibrary.org/contribute/. There you will find all you need to know about “Audio recording techniques” and “Audio recording gear,” including up-to-date information on microphones, digital audio recorders, accessories, and smartphones. As of 2019, there are three superb videos by Greg Budney, ex-curator of the Library, telling how to record: The Basics, With Parabola, and With Shotgun Microphone.</p> 
				<p>An exercise prepared for the Wilson Ornithological Society also provides information on how to record with smartphones: https://wilsonsociety.org/pubs/manual-of-field-and-laboratory-exercises-for-ornithology/.</p>
				<p>My favorite recording system? I love parabolic microphones, because the highly directional parabolic reflector physically amplifies the sound from a distant source and concentrates it at the microphone, enabling much “cleaner” recordings of distant birds than a shotgun microphone can provide (but see advantages and disadvantages of various microphones on the Cornell website). I use a stereo Telinga microphone (http://www.telinga.com/) in the parabola, with good headphones over the ears (Sennheiser HD 25-1 II). For a recorder, I use a Sound Devices digital recorder (Model 722, an old one!), and my partner Janet Grenzke uses a Marantz PMD661. Our next recorder will probably be a MixPre from Sound Devices.</p>
				<p>When I want long recordings, perhaps even overnight, and when I can set the microphone fairly close to the bird, I use a Marantz PMD661 recorder and an Audio Technica BP4027 stereo shotgun microphone. An external Voltaic battery (Model V44) supplies the power for a session that might last overnight. Sample recordings with this setup include the night-singing mockingbirds (e.g., ♫238, ♫516) and the sage thrasher who sang predictably during the daytime from just a few perches (e.g., ♫518, ♫528).</p>
				<p>When I want to program a recorder to record only at certain times of the day over a week or more, all unattended, and when I will settle for a monaural recording, I use a SWIFT (http://www.birds.cornell.edu/brp/swift/). Sample recordings include those from the night-singing sage thrasher (e.g., ♫519-527, ♫529-531), from the male northern cardinal singing at dawn (♫468-476), and from the female cardinal singing on the nest (♫60).</p>
				
			</div><!--recording-birdsong-->
			
			<div id="additional-resources" class="switch">
				<h2>Additional Resources</h2>
				
				
				<p>1) Check out the exercise prepared for The Wilson Ornithological Society, on “Recording and analysis of bird vocalizations,” by Sylvia L. Halkin and Walter J. Berry, found at https://wilsonsociety.org/pubs/manual-of-field-and-laboratory-exercises-for-ornithology/. It offers good “how to” information: How to get the best recordings you can with a smartphone, extensive and helpful notes on how to use Raven Lite for analyzing sounds, etc. Included is a useful glossary of terms (e.g., vocalization, frequency, amplitude, etc.), and a list of questions you might be able to answer about bird sounds, much like my Explore sections.</p>
				<p>2) The Cornell Lab of Ornithology’s “All About Birdsong,” https://academy.allaboutbirds.org/all-about-bird-song/. With audio and video; a game on bird identification included for 30 species. </p>
				<p>3) On the internet you can find more bird sounds for your listening pleasure and study.
				https://www.xeno-canto.org/ —  “a website dedicated to sharing bird sounds from all over the world.”
				https://www.macaulaylibrary.org/ — A rapidly growing archive of brief sound clips, as birders attach recordings to their eBird submissions. All recordings can be viewed as sonagrams. 
				https://osuc.biosci.ohio-state.edu/blb/ — “one of the oldest and most extensive . . . collections of recorded animal sounds . . . in the world . . .”
				https://www.floridamuseum.ufl.edu/bird-sounds/--sounds from over 3000 species of birds, all available online
				https://sounds.bl.uk/ — The British Library. An extensive, eclectic collection of earth sounds, including “Environment and Nature”
				https://academy.allaboutbirds.org/avian-vocal-behavior-sound-visualizations/. Sonagrams and accompanying sounds, illustrating Chapter 10 in the Handbook of Bird Biology, 3rd edition, from the Cornell Lab of Ornithology.
				http://listeningtoacontinentsing.com/— a sample of bird sounds from North America, rich in explanation as to what you are hearing. This is the companion website to my book Listening to a Continent Sing. Birdsong by Bicycle from the Atlantic to the Pacific.</p>
				...
				<ul>
					...
					<li>Elliott, Lang. https://musicofnature.com/. The Music of Nature. Celebrating the Voices of the Natural World. Elliott is a first-rate sound recordist, of birds, frogs, mammals, insects, and more, and author of many books on bird song (e.g., Common Birds and their Sounds; Music of the Birds—A Celebration of Bird Song).</li> 
					<li>Kroodsma, D. 2005. The Singing Life of Birds. The Art and Science of Listening to Birdsong. Boston, Massachusetts, Houghton-Mifflin Co. Winner of the John Burroughs Medal for natural history writing.</li> 
					<li>Kroodsma, D. 2008. The Backyard Birdsong Guide. Eastern and Central North America, and Western North America. San Francisco, California, Chronicle Books. Has sold nearly half a million copies; suitable for young of all ages, with an electronic module that plays the sounds for each of 75 species. More recently republished by Princeton University Press and the Cornell Lab Publishing Group.</li>
					<li>Kroodsma, D. 2009. Birdsong by the Seasons. A Year of Listening to Birds. Boston, Massachusetts, Houghton-Mifflin Harcourt Co. Twenty-four chapters, exploring bird sounds from January through December.</li>
					<li>Kroodsma, D. 2016. Listening to a Continent Sing. Birdsong by Bicycle from the Atlantic to the Pacific. Princeton, New Jersey, Princeton University Press. A 4500-mile bicycle ride from Virginia to Oregon, with my son David, listening to birds every inch of the way. On the companion website, http://listeningtoacontinentsing.com/, you can choose how to listen to the 381 recordings from this journey (by species, by location, or during the dawn chorus). Explanations on how to listen are provided for each recording, with background species noted.</li>
					<li>Low, T. 2014. Where song began. Australia’s Birds and how they Changed the World. New Haven, Connecticut, Yale University Press. An exciting look at how birds sing so differently “down under.”</li>
					<li>Pieplow, N. 2017. Peterson Field Guide to Bird Sounds of Eastern North America. Houghton Mifflin Harcourt, Boston, Massachusetts. “ . . . the most comprehensive reference to North American bird sounds ever produced . . .”</li>
					<li>Stap, D. 2005. Birdsong: A Natural History. New York City, New York, Charles Scribner's Sons. A “creative mixture of reportage, storytelling, and research, Stap distills the complexities of the study of birdsong and unveils a remarkable discovery that sheds light on the mystery of mysteries . . .” (Amazon)</li>
					<li>Taylor, H. 2017. Is Birdsong Music? Outback Encounters with an Australian Songbird. Bloomington, Indiana, Indiana University Press. From the perspective of a musician.</li>
					<li>Young, J. 2012. What the Robin Knows. How Birds reveal the Secrets of the Natural World. Boston, Massachusetts, Houghton-Mifflin Harcourt Co. “Here is the ancestral wisdom passed down from the Apache elder Stalking Wolf to the renowned tracker Tom Brown to Jon Young himself . . . the art of truly listening to the avian soundscape.”</li>
				</ul>
