...
<body class="explore">
	...
	<section id="content">
		...
		<div class="main">
			...
			<h2><i class="fas fa-search"></i> Explore #1: Chick-a-dee calls of North American chickadees.</h2>
			<h5 class="meta"><a href="search.php#chapter-list"><i class="fas fa-book-open"></i> Chapter 2:  Birds and Their Sounds</a></h5>
			<h5><a href="search.php#chapter-list"><i class="fas fa-list"></i> Subchapter: Birds sing, and call</a></h5>
			<h5 class="meta"><i class="fas fa-bookmark"></i> From page xxx in the book.</h5>
